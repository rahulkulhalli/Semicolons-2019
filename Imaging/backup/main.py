...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, help='Dataset to visualize e.g. Malaria, Pneumonia', default='malaria')

    parser.add_argument('--model_filename', type=str, help='Model Filename. Defaults to Malaria.',
                        default='/home/ubuntu/semic-web/image/Models/malaria.h5')
...
application_model = model_utils.ApplicationModel(model, model_mod,
                                     make_linear=True, preprocessing_function=config.preprocessing_function,
